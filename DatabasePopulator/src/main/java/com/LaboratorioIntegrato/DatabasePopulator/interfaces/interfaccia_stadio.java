...
public interface interfaccia_stadio extends JpaRepository<Stadio, Integer> {
    ...
    Boolean InserisciStadio(@Param(value = "id")int id, @Param(value = "nome")String nome,@Param(value = "indirizzo")String indirizzo, @Param(value = "citta")String citta, @Param(value = "capacita")int capacita,@Param(value = "terreno")String terreno,@Param(value = "immagine")String immagine);
}
