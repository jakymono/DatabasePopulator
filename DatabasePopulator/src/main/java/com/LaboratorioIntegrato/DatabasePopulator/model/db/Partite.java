...
public class Partite
{
    ...
    public Partite(int id, int id_casa, int id_ospite, int id_stadio, int id_campionato, String arbitro, Timestamp timestamp_partita, String status, int gol_casa, int gol_ospiti, int gol_casa_suppl, int gol_ospiti_suppl, int rigori_finali_casa, int rigori_finali_ospiti) {
        this.id = id;
